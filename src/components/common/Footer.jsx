...
//                                 <div className='flex justify-evenly text-center space-x-4'>
//                                     <a className='text-center' target='_blank' rel="noopener noreferrer" href="https://www.instagram.com/sayme_vishesh/">
//                                         <FaInstagram className='mx-auto' />
//                                         <p className="hover:text-pink-500">Instagram</p>
//                                     </a>
//                                     <a className='text-center' target='_blank' rel="noopener noreferrer" href="https://github.com/Vishesh9310">
//                                         <FaGithub className='mx-auto' />
//                                         <p className="hover:text-gray-500">Github</p>
//                                     </a>
//                                     <a className='text-center' target='_blank' rel="noopener noreferrer" href="https://www.facebook.com">
//                                         <FaFacebook className='mx-auto' />
//                                         <p className="hover:text-blue-700">Facebook</p>
//                                     </a>
//                                     <a className='text-center' target='_blank' rel="noopener noreferrer" href="https://www.linkedin.com/in/vishesh-b8a2b72a3?utm_source=share&utm_campaign=share_via&utm_content=profile&utm">
